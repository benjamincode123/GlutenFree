...
export default function AdminScreen() {
  ...
  const applyList = useCallback((result: adminApi.ProductSubmissionList) => {
  ...
  useFocusEffect(
    ...
    }, [authEnabled, isAdmin, page, router, t, applyList])
  );
          ...
          return (
            ...
            >
              ...
              <AppTextInput
                ...
                onChangeText={(ingredients) => updateDraft(item.id, { ingredients })}
                editable={busyId === null}
                multiline
                  ...
                  <Pressable
                    ...
                    style={[
                      styles.ratingOption,
                      {
                        ...
                        backgroundColor: selected ? meta.backgroundColor : colors.background,
                      },
                    ]}
                    disabled={busyId !== null}
                    onPress={() => updateDraft(item.id, { glutenRating: option })}
                  >
